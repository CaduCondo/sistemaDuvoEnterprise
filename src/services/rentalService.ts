...
export const create = async (rental: Partial<Rental>): Promise<Rental> => {
  const rentalData: any = {
    ...
    garage_value: rental.garageValue || null,
    has_partner_broker: rental.hasPartnerBroker || false,
    attachments: rental.attachments || [], // ✅ CRITICAL: Salvar attachments
    contract_attachments: rental.contractAttachments || [], // ✅ CRITICAL: Salvar contract_attachments
  };

  // Campos de caução (mantidos para compatibilidade)
  if (rental.depositInstallments !== undefined) rentalData.deposit_installments = rental.depositInstallments;
  if (rental.depositInstallment1 !== undefined) rentalData.deposit_installment1 = rental.depositInstallment1;
  if (rental.depositInstallment1DueDate !== undefined) rentalData.deposit_installment1_due_date = rental.depositInstallment1DueDate;
  if (rental.depositInstallment1PaymentDate !== undefined) rentalData.deposit_installment1_payment_date = rental.depositInstallment1PaymentDate;
  if (rental.depositInstallment1PixCode !== undefined) rentalData.deposit_installment1_pix_code = rental.depositInstallment1PixCode;
  if (rental.depositInstallment2 !== undefined) rentalData.deposit_installment2 = rental.depositInstallment2;
  if (rental.depositInstallment2DueDate !== undefined) rentalData.deposit_installment2_due_date = rental.depositInstallment2DueDate;
  if (rental.depositInstallment2PaymentDate !== undefined) rentalData.deposit_installment2_payment_date = rental.depositInstallment2PaymentDate;
  if (rental.depositInstallment2PixCode !== undefined) rentalData.deposit_installment2_pix_code = rental.depositInstallment2PixCode;
  if (rental.depositInstallment3 !== undefined) rentalData.deposit_installment3 = rental.depositInstallment3;
  if (rental.depositInstallment3DueDate !== undefined) rentalData.deposit_installment3_due_date = rental.depositInstallment3DueDate;
  if (rental.depositInstallment3PaymentDate !== undefined) rentalData.deposit_installment3_payment_date = rental.depositInstallment3PaymentDate;
  if (rental.depositInstallment3PixCode !== undefined) rentalData.deposit_installment3_pix_code = rental.depositInstallment3PixCode;

  console.log("📦 [rentalService.create] Dados que serão salvos:", rentalData);
  console.log("📎 [rentalService.create] Attachments sendo salvos:", rentalData.attachments); // ✅ DEBUG

  const { data, error } = await supabase.from("rentals").insert(rentalData).select().single();
...
export const update = async (id: string, rental: Partial<Rental>): Promise<Rental> => {
  ...
  // Campos básicos
  if (rental.propertyId !== undefined) updateData.property_id = rental.propertyId;
  if (rental.tenantId !== undefined) updateData.tenant_id = rental.tenantId;
  ...
  if (rental.paymentDay !== undefined) updateData.payment_day = rental.paymentDay;
  if (rental.value !== undefined) updateData.value = rental.value;
  if (rental.monthlyRent !== undefined) updateData.monthly_rent = rental.monthlyRent;
  if (rental.depositAmount !== undefined) updateData.deposit_amount = rental.depositAmount;
  if (rental.status !== undefined) updateData.status = rental.status;
  if (rental.isActive !== undefined) updateData.is_active = rental.isActive;
  ...
  if (rental.hasPartnerBroker !== undefined) updateData.has_partner_broker = rental.hasPartnerBroker;
  if (rental.attachments !== undefined) updateData.attachments = rental.attachments; // ✅ CRITICAL: Atualizar attachments
  if (rental.contractAttachments !== undefined) updateData.contract_attachments = rental.contractAttachments; // ✅ CRITICAL: Atualizar contract_attachments

  // Campos de caução (mantidos para compatibilidade)
  if (rental.depositInstallments !== undefined) updateData.deposit_installments = rental.depositInstallments;
  if (rental.depositInstallment1 !== undefined) updateData.deposit_installment1 = rental.depositInstallment1;
  if (rental.depositInstallment1DueDate !== undefined) updateData.deposit_installment1_due_date = rental.depositInstallment1DueDate;
  if (rental.depositInstallment1PaymentDate !== undefined) updateData.deposit_installment1_payment_date = rental.depositInstallment1PaymentDate;
  if (rental.depositInstallment1PixCode !== undefined) updateData.deposit_installment1_pix_code = rental.depositInstallment1PixCode;
  if (rental.depositInstallment2 !== undefined) updateData.deposit_installment2 = rental.depositInstallment2;
  if (rental.depositInstallment2DueDate !== undefined) updateData.deposit_installment2_due_date = rental.depositInstallment2DueDate;
  if (rental.depositInstallment2PaymentDate !== undefined) updateData.deposit_installment2_payment_date = rental.depositInstallment2PaymentDate;
  if (rental.depositInstallment2PixCode !== undefined) updateData.deposit_installment2_pix_code = rental.depositInstallment2PixCode;
  if (rental.depositInstallment3 !== undefined) updateData.deposit_installment3 = rental.depositInstallment3;
  if (rental.depositInstallment3DueDate !== undefined) updateData.deposit_installment3_due_date = rental.depositInstallment3DueDate;
  if (rental.depositInstallment3PaymentDate !== undefined) updateData.deposit_installment3_payment_date = rental.depositInstallment3PaymentDate;
  if (rental.depositInstallment3PixCode !== undefined) updateData.deposit_installment3_pix_code = rental.depositInstallment3PixCode;

  console.log("📦 [rentalService.update] Dados que serão atualizados:", updateData);
  console.log("📎 [rentalService.update] Attachments sendo atualizados:", updateData.attachments); // ✅ DEBUG

  const { data, error } = await supabase.from("rentals").update(updateData).eq("id", id).select().single();
